 ...
 *
 * $ gcc -std=c99 cpu_rand_bits64_oneil.c -o cpu_rand_bits64_oneil
 */
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
...
int main() {
    ...
    /*  *\/ */
    /* cl_ulong *rndb_local; */
    /* cl_ulong brnd, brndmin = ULONG_MAX, brndmax = 0; */
    
    /* for (size_t iseq=0; iseq<Nproc; iseq++) { */
    /*     rndb_local = rndb + iseq*nrnd; */
    /*     for (cl_ulong irnd=0; irnd<nrnd; irnd++) { */
    /*         brnd = rand64_bits(&rndst[iseq]); */
    /*         if (brnd < brndmin) brndmin = brnd; */
    /*         if (brnd > brndmax) brndmax = brnd; */
    /*         *rndb_local++ = brnd; */
    /*     } */
    /* } */
    ...
    /* printf("\n"); */
    /* printf("Application brndmin = %20lu brndmax = %20lu\n", brndmin, brndmax); */
    ...
    rndst1.s[0] = 0x1a3e1765f0739e39;
    rndst1.s[1] = 0xf5d7f1bb420e645d;
    rndst1.s[2] = 0x16a5269645b3a76f;
    rndst1.s[3] = 0xbb126a5fd07a5f1e;
    ...
    //cl_ulong xstate = 12345;
    uint64_t rn = 0, xstate = 0x12345;
